...
public class ReciboService {
    ...
    public void gravaReciboTxt(List<Recibo> lista, String nomeArq) {
        ...
        for (Recibo a : lista) {
            ...
            corpo += String.format("%-50.50s", a.getEndereco());
            corpo += String.format("%-50.50s", a.getDescricao());
            corpo += String.format("%02d", a.getQtdQuartos());
            corpo += String.format("%04d", a.getCurtidas());
            corpo += String.format("%1d", a.getAvaliacao());
            corpo += String.format("%08.2f", a.getPreco());
            contaRegDados++;
        ...
        try{
            for (int i = 0; i < lista.getTamanho(); i++){
                ...
                saida.format("%d;%s;%s;%s;%d;%d;%d;%.2f\n",
                        r.getId(),r.getNome(),r.getEndereco(),r.getDescricao(),r.getQtdQuartos(),r.getCurtidas(),r.getAvaliacao(),r.getPreco());
            }
